...
<div className="mt-10">
  ...
  <AccordionTrigger>¿Por qué aparecen porcentajes en las provincias?</AccordionTrigger>
  <AccordionContent>
    Dependiendo de tu provincia de residencia o donde facturás, pueden aplicarse tasas de Ingresos Brutos (IIBB) o IVA distintas. Estas tasas varían entre 0% y 5,5%. Algunas jurisdicciones, como Tierra del Fuego, están exentas de IVA.
  </AccordionContent>
</AccordionItem>
