  ...
  <span className="font-bold text-lg"></span>
          ...
          <div className="hidden md:block">
            ...
            <Link to="/" className="text-sm font-medium hover:text-primary transition-colors"> Inicio</Link>
              ...
              <NavLink to="/CalculaTuSueldo">Calculá tu sueldo</NavLink>
      ...
      {mobileMenuOpen && (
        <div className="md:hidden bg-card/90 backdrop-blur-md">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            <a  href="/calcula-tu-sueldo"  className="text-sm font-medium text-foreground hover:text-primary"> Calculá tu sueldo </a>
